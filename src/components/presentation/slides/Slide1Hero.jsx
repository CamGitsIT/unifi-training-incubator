        ...
        <div className="relative min-h-screen flex items-center overflow-hidden bg-slate-950">
            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto px-8 md:px-16 py-24">
                ...
                >
                    ...
                    >
                        We've <strong className="text-slate-200">fused</strong> Ubiquiti's subscription-free, market-disrupting technology stack <strong className="text-slate-200">with</strong> our first-ever UniFi Experience Center—purpose-built for real estate developers, property managers, and multi-location operators. Our national Certification Training Center builds a bench of experts, while AI-driven lead generation keeps the entire machine moving. Every part feeds the others—a scalable model for us, and a smarter, more frictionless experience for our clients.<p>Welcome to the future of IT infrastructure and software. We’ve <b>fused</b> Ubiquiti’s newly released, subscription-free, market-disrupting technology stack <b>with</b> our first-ever UniFi Experience Center—purpose-built for real estate developers, professional property managers, and multi-location operators who are tired of overpaying for fragmented systems.<p>At the same time, we’re building a national bench of experts through our Certification Training Center, while advanced AI-driven lead generation helps keep the entire machine moving. <p> This is a deliberately connected ecosystem. The showroom supports the sales process. The training center builds authority and talent. The technology stack solves real operational problems. Each part feeds the others. The result is a scalable, efficient model for us—and a smoother, smarter, more frictionless experience for our clients.
                    </motion.p>
