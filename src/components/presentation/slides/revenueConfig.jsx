...
export const STREAMS = [
  ...
  // Combined: hardware dropship profit ($300/visit) + design consulting ($300/visit) = $600/visit
  {
    ...
    emoji: '🏢',
    what: 'A live UniFi showcase in a real building. Qualified visits generate dropship hardware profit plus a paid 2-hour design consult.',
    whoServes: 'Developers, property managers, HOA boards, MSPs, and retail operators.',
    howWeEarn: '$300 dropship profit + $300 design consult (2hr × $150/hr) = $600 per visit.',
    liveProof: 'Sager Lofts is live with UniFi keyless entry and biometrics — the space is the demo.',
  ...
  // ── 4. Multi-Location Retail ──────────────────────────────────
  {
    ...
    emoji: '🏪',
    what: 'We design and sell UniFi rollout plans for multi-location retail brands. A licensed integrator handles installation — we earn the design fee.',
    whoServes: 'Regional chains, franchise operators, QSR brands with 20–200+ locations.',
    howWeEarn: '12.5% design fee on avg $4,000/site × 20 sites = $10,000/account. Pipeline grows as licensed integrator partners scale.',
    driver: {
    ...
    assumptions: {
      ...
      feePercent: 12.5,
      scenarioNote: 'New account signing rate grows 7%/month (compounding). Partner-executed by licensed integrators — no install labor bottleneck. Conservative/Stretch adjusts account volume.',
    },
    proof: [],
  ...
  // ── 7. Refrigeration & Temperature Monitoring ─────────────────
  {
    ...
    revenueFormula: (d) => `$5,000 setup × 10 sensors/location × ${d} locations × growth_factor\n= sensor hardware + FDA-compliant cloud reporting`,
    assumptions: {
  ...
  // ── 8. Micro ISP ──────────────────────────────────────────────
  {
    ...
    emoji: '📡',
    what: 'We install community-owned mesh WiFi — residents pay less for better internet; OverIT collects the recurring fee.',
    whoServes: 'Apartment buildings, mobile home communities, HOAs seeking internet as an amenity.',
    howWeEarn: '$41.25/unit/month (75% of $55). 25% back to the HOA drives adoption. 3 buildings × 40 units = $4,950/mo — self-renewing by design.',
    driver: {
