...
export const BASELINE_STREAMS = [
  ...
  { stream_id: 'training',                     stream_title: 'UniFi Certification Training (Multi-day)',        driver_name: 'Seats per month',            driver_unit: 'seats/mo',       plan_driver_m1: 20,  units_per_driver: 1,  unit_revenue: 2000,   monthly_growth: 0.10,  enabled: true },
