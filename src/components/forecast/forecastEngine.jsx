...
export const BASELINE_STREAMS = [
  { stream_id: 'experience',    stream_title: 'Experience Center',                        driver_name: 'Qualified visits per month',  driver_unit: 'visits/mo',      plan_driver_m1: 40,  units_per_driver: 1,  unit_revenue: 30,    monthly_growth: 0.09, enabled: true },
  { stream_id: 'training',      stream_title: 'UniFi Certification Training',              driver_name: 'Seats per month',             driver_unit: 'seats/mo',       plan_driver_m1: 8,   units_per_driver: 1,  unit_revenue: 2000,  monthly_growth: 0.10, enabled: true },
  { stream_id: 'retrofit',      stream_title: 'Keyless Property Access (Retrofit)',        driver_name: 'Projects sold per month',     driver_unit: 'projects/mo',    plan_driver_m1: 4,   units_per_driver: 6,  unit_revenue: 1125,  monthly_growth: 0.07, enabled: true },
  { stream_id: 'retail',        stream_title: 'Multi-Location Retail Businesses',          driver_name: 'Active brand accounts',       driver_unit: 'accounts/mo',    plan_driver_m1: 2,   units_per_driver: 20, unit_revenue: 3500,  monthly_growth: 0.08, enabled: true },
