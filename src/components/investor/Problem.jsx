            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="bg-gradient-to-br from-red-950/30 to-slate-900/30 border border-red-900/50 rounded-2xl p-8"
                    >
                        ...
                        <div className="space-y-3 text-slate-300">
                            <div className="flex items-center gap-3">
                                ...
                                <span>$80/month per callbox for analog phone lines</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-2 h-2 bg-red-400 rounded-full" />
                                <span>Some condos pay $1,900/month for multiple lines</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-2 h-2 bg-red-400 rounded-full" />
                                <span>Copper infrastructure being phased out nationwide</span>
                            </div>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-gradient-to-br from-orange-950/30 to-slate-900/30 border border-orange-900/50 rounded-2xl p-8"
                    >
                        ...
                        <div className="space-y-3 text-slate-300">
                            <div className="flex items-center gap-3">
                                ...
                                <span>$3,000 - $15,000/year in subscription fees</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-2 h-2 bg-orange-400 rounded-full" />
                                <span>Perpetual liability on property budgets</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-2 h-2 bg-orange-400 rounded-full" />
                                <span>Fees often escalate year after year</span>
                            </div>
